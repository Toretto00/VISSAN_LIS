...
const PreviewCard = ({ invoiceData, id }: { invoiceData: InvoiceDetailType; id: string }) => {
                            ...
                            <div className='flex justify-between gap-y-4 flex-col sm:flex-row'>
                                ...
                                <div className='flex flex-col gap-6'>
                                    ...
                                    <div className='flex flex-col gap-1'>
                                        <Typography color='text.primary'>{`Date: ${invoiceData?.products[0].created}`}</Typography>
                                        <Typography color='text.primary'>{`Status: ${invoiceData.products[0].invoice.status}`}</Typography>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <Grid container spacing={6}>
                            <Grid item xs={12} sm={6}>
                                <div className='flex flex-col gap-4'>
                                    ...
                                    <div>
                                        <Typography>{invoiceData?.store.storeid}</Typography>
                                        <Typography>{invoiceData?.store.retailname}</Typography>
                                        <Typography>{invoiceData?.store.retailsystem}</Typography>
                                    </div>
                                </div>
                            </Grid>
                            {/* <Grid item xs={12} sm={6}>
