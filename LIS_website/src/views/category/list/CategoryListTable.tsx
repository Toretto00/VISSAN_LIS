...
import { add, update, destroy } from "@/stores/category"
...
const CategoryListTable = ({ tableData }: { tableData?: CategoryType[] }) => {
  // States
  ...
  // Hooks
  const handleEvent = async (category: any) => {
    if (category.id) {
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({ row }) => (
          <div className='flex items-center'>
            ...
            <IconButton onClick={() => destroyEvent(row.original.id)}>
  ...
  return (
    <>
      ...
      <AddDrawer open={isSidebarOpen} handleClose={() => setOpen(!isSidebarOpen)} handleEvent={handleEvent} />
    </>
  )
}
