...
import { putInvoice } from '@/stores/invoice'
...
const handleEditInvoice = async (id: number, status: string) => {
    const res = await putInvoice(id, JSON.stringify({
        status: `${status}`
    }))

    if (!res.ok)
        throw new Error("Fail to edit invoice!")
            ...
            <Card>
                <CardContent className='flex flex-col gap-4'>
                    ...
                    <Button
                        ...
                        className='capitalize'
                        onClick={() => {
                            handleEditInvoice(Number(id), "approved")
                        }}
                    ...
                    <Button
                        ...
                        variant='contained'
                        className='capitalize'
                        onClick={() => handleEditInvoice(Number(id), "denied")}
