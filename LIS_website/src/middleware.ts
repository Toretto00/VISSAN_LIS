...
export default withAuth(
  async function middleware(request: NextRequestWithAuth) {
    ...
    // Constants
    const HOME_PAGE_URL = token?.role === 'user' ? '/client/dashboard' : '/admin/dashboard'
...
export const config = {
  matcher: [
     ...
     */
    '/((?!api|_next/static|_next/image|favicon.ico|.+?/hook-examples|.+?/menu-examples|images|next.svg|vercel.svg|.*\\.png$|.*\\.jpg$).*)'
  ]
}
